...
const MOCK_TRANSACTIONS = [
  { id: 't-1', userId: DEMO_USER_ID, amount: 450,  category: 'food',        sentiment: 'neutral',  description: 'Zomato order lunch',         timestamp: new Date('2025-03-24T12:30:00') },
  { id: 't-2', userId: DEMO_USER_ID, amount: 1200, category: 'shopping',    sentiment: 'negative', description: 'Amazon impulse purchase',     timestamp: new Date('2025-03-24T23:15:00') },
  { id: 't-3', userId: DEMO_USER_ID, amount: 350,  category: 'travel',      sentiment: 'neutral',  description: 'Uber ride to office',        timestamp: new Date('2025-03-25T09:00:00') },
  { id: 't-4', userId: DEMO_USER_ID, amount: 8500, category: 'bills',       sentiment: 'negative', description: 'Electricity bill payment',   timestamp: new Date('2025-03-25T11:00:00') },
  { id: 't-5', userId: DEMO_USER_ID, amount: 600,  category: 'food',        sentiment: 'neutral',  description: 'Swiggy dinner',              timestamp: new Date('2025-03-26T20:00:00') },
  { id: 't-6', userId: DEMO_USER_ID, amount: 300,  category: 'food',        sentiment: 'impulse',  description: 'Blinkit late night snacks',  timestamp: new Date('2025-03-26T23:45:00') },
  { id: 't-7', userId: DEMO_USER_ID, amount: 2000, category: 'shopping',    sentiment: 'neutral',  description: 'Flipkart headphones',        timestamp: new Date('2025-03-27T14:00:00') },
  { id: 't-8', userId: DEMO_USER_ID, amount: 500,  category: 'food',        sentiment: 'neutral',  description: 'Restaurant dinner with team', timestamp: new Date('2025-03-27T19:30:00') },
  { id: 't-9', userId: DEMO_USER_ID, amount: 150,  category: 'travel',      sentiment: 'neutral',  description: 'Metro card recharge',        timestamp: new Date('2025-03-28T08:00:00') },
  { id: 't-10',userId: DEMO_USER_ID, amount: 4500, category: 'health',      sentiment: 'neutral',  description: 'Pharmacy medicines',         timestamp: new Date('2025-03-28T16:00:00') },
];
